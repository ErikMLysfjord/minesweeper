...
public class HighscoreListTest {
    ...
    public void testAddEntry() {
        ...
        Assertions.assertEquals(li, highscoreList.getHighscoreEntry(0));
        Assertions.assertEquals(erik, highscoreList.getHighscoreEntry(1));
        ...
        Assertions.assertEquals(li, highscoreList.getHighscoreEntry(0));
        Assertions.assertEquals(vebjorn, highscoreList.getHighscoreEntry(1));
        Assertions.assertEquals(ole, highscoreList.getHighscoreEntry(2));
